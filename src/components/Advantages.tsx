    ...
    <section className="py-16 bg-brand-light">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-brand-dark mb-4">Почему выбирают нас</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Мы стремимся предоставить лучший сервис и качество для наших клиентов
          </p>
        </div>
          ...
          {advantages.map((advantage, index) => (
            ...
            >
              <div className="h-16 w-16 rounded-full bg-brand-red/10 flex items-center justify-center mb-4">
                <Icon name={advantage.icon} className="h-8 w-8 text-brand-red" />
              </div>
              <h3 className="font-montserrat font-semibold text-xl mb-2">{advantage.title}</h3>
